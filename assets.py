...
def load_assets(fase, corrent_colors):
    ...
    background_img = pygame.image.load(f'{path}{fase_nome}.png')
    background_img = pygame.transform.scale(background_img, (WIDTH,HEIGHT))

    chao_img = pygame.image.load(f'{path}piso {fase_nome}.png')
    chao_img = pygame.transform.scale(chao_img, (SIZE,SIZE))

    parede_img = pygame.image.load(f'{path}parede {fase_nome}.png')
    ...
    for i in range(2):
        ...
        img = pygame.transform.scale(img, (SIZE, SIZE*1.5))
    ...
    inimigo_img = pygame.image.load(f'{path}inimigo.png')
    ...
    botao_img = pygame.transform.scale(botao_img, (SIZE/2, SIZE/2))
